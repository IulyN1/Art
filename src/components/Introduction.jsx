		...
		<section className="introduction">
			...
			>
				<div className="definition">
					<a href="https://dictionary.cambridge.org/dictionary/english/art" target="_blank" rel="noreferrer">
			...
			>
				<div className="definition mine">
					<span>
						Art is the embodiment of an idea or a manifestation of imagination, emotion, or thought brought
			...
			>
				...
				<div className="definition">
					...
					<span>
						Art is something beautiful, pleasant, something that would make me linger in front of it or make
						me think a lot about it.
					</span>
				</div>
				<div className="definition">
